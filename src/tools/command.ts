...
export const commandTools: ToolDefinition[] = [
  {
    name: "run_cmd",
    description:
      "Run an unsandboxed shell command. NEVER use this tool when another provided tool can perform the operation. Use it only when all other tools are unsuitable. Examples: listing (`ls`), creating directories (`mkdir dir`), deleting (`rm file`), copying (`cp a b`), moving, or renaming (`mv a b`).",
    inputSchema: {
